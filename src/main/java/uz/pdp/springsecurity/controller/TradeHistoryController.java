...
public class    TradeHistoryController {
    ...
    @PutMapping("/{id}")
    public HttpEntity<?> edit(@PathVariable UUID id, @Valid @RequestBody TradeHistoryDto tradeHistoryDto) {
    ...
    public HttpEntity<?> deleteByTradeId(@PathVariable UUID trade_id) {
    ...
    public HttpEntity<?> deleteAllByTradeId(@PathVariable UUID trade_id) {
    ...
    public HttpEntity<?> getAllByTradeId(@PathVariable UUID trade_id) {
    ...
    @CheckPermission("VIEW_MY_TRADE")
    @GetMapping("/{trade_id}")
    public HttpEntity<?> getByTradeId(@PathVariable UUID trade_id) {
